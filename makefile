all : simpler mpdata_advec_test

FC = mpif90
FLAGS = -fc=ifort -xhost -O2
#FLAGS=-xhost -pg -O2 (-pg is for profiling) 
#FLAGS= -fc=ifort -g -traceback #-check bounds/all (all checks everything) -fpe0 (tracks floating point errors) 

obs=decompu.o mkgridu.o calc_au.o calc_ap.o calc_aw.o mpdata_flux.o diffusion.o strainrate.o strainrate2.o fineness.o smooth.o nbrex2d2.o tracer_advec.o nbrex2d_tracer_counts.o nbrex2d_tracer_dat.o interpgen2d_geo.o nbrex2d_int.o mpdata_flux_gen.o

mods=btype.f90 bfunc2d.f90 bfunc2d_main.f90  
...
mpdata_advec_test : $(mods) $(obs) mpdata_advec_test.f90 $(libs) 
	$(FC) $(FLAGS) $(mods) $(obs) mpdata_advec_test.f90 $(libs) -o mpdata_advec_test
...
libmg2dp.a : mg2d.o mkgrid.o decomp.o jacobi2dfvp2.o nbrex2d.o interpgen2d.o rstrct2dp_gen.o resid2dfvp2.o 
	ar rvs libmg2dp.a mg2d.o mkgrid.o decomp.o jacobi2dfvp2.o nbrex2d.o interpgen2d.o rstrct2dp_gen.o resid2dfvp2.o 
...
mg2d.o : btype.f90 bfunc2d.f90 rstrct2dp_gen.o resid2dfvp2.o interpgen2d.o nbrex2d.o jacobi2dfvp2.o mg2d.f90
	$(FC) $(FLAGS) -c btype.f90 bfunc2d.f90 rstrct2dp_gen.o resid2dfvp2.o interpgen2d.o nbrex2d.o jacobi2dfvp2.o mg2d.f90 
...
mpdata_flux_gen.o : btype.f90 bfunc2d.f90 mpdata_flux_gen.f90 
	$(FC) $(FLAGS) -c bfunc2d.f90 btype.f90 mpdata_flux_gen.f90
...
rstrct2dp_gen.o : btype.f90 rstrct2dp_gen.f90 
	$(FC) $(FLAGS) -c btype.f90 rstrct2dp_gen.f90
